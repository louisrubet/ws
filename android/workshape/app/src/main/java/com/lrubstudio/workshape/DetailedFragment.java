...
public class DetailedFragment extends DataFragment implements View.OnClickListener, DbRequest.AsyncResponse, DateTimeGetter.onDateTimeGetter
{
    ...
    int[] _ids = new int [] {
            ...
            R.id.editDureeDeVie20, R.id.editDureeDeVieMoins18, R.id.editNumeroDeSerie
    };
    ...
    String[] _fields = new String [] {
            ...
            DbProduct.dureeDeVie20, DbProduct.dureeDeVieMoins18, DbProduct.numeroDeSerie
    };
    ...
    public void onClick(View view)
    {
        ...
        if (view.getId() == R.id.buttonAddModify)
        {
            ...
            String numeroDeSerie = ((EditText) getView().findViewById(R.id.editNumeroDeSerie)).getText().toString();
            ...
            if (MainActivity.getLastRequestedProduct().isNewQrCode())
                ...
                DbRequest.createCommand(this, null).execute(DbProduct.buildRequestProductAdd(getActivity(),
                        ...
                        typeDeTissus, dateArrivee, transportFrigo, lieuActuel, finished, dureeDeVie20, dureeDeVieMoins18, numeroDeSerie,
