...
--
-- Host: 192.168.1.14    Database: workshapedb
-- ------------------------------------------------------
...
--
-- Table structure for table `current_out`
--

DROP TABLE IF EXISTS `current_out`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `current_out` (
  `idcurrent_out` int(11) NOT NULL,
  `fk_idproduct` int(11) DEFAULT NULL,
  `date_out` datetime DEFAULT NULL,
  PRIMARY KEY (`idcurrent_out`),
  KEY `fk_idproduct_idx` (`fk_idproduct`),
  CONSTRAINT `fk_idproduct` FOREIGN KEY (`fk_idproduct`) REFERENCES `product` (`idproduct`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `product` (
  ...
  `transport_frigo` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2016-04-26 22:51:48
